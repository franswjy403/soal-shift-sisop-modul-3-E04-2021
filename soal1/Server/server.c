...
char server_path[500] = "/home/frans0416/Documents/sisopE/soal-shift-sisop-modul-3-E04-2021/soal1/Server/";
char client_path[500] = "/home/frans0416/Documents/sisopE/soal-shift-sisop-modul-3-E04-2021/soal1/Client/";
char folderpath[500];
char logpath[500];
char tsvpath[500];
client curr_client;
...
bool soal_e(int sock, char del_tsv[]){
	...
	if (found) {
		// rename file
		char newname[600] = {0}, oldname[600] = {0};
